...
<?php endif; ?>
                        <form method="POST" action="<?php echo e(route('login')); ?>" data-toggle="validator">
                           ...
                           <p class="mt-3 text-center">
                              Don’t have an account? <a href="<?php echo e(route('auth.signup')); ?>" class="text-underline">Click here to sign up.</a>
                           </p>
                        </form>
                     </div>
                  </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\serin\Desktop\4TWIN\5TWIN\LARAVEL\Laravel_RescuFood\resources\views/auth/login.blade.php ENDPATH**/ ?>