        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                 <a href="<?php echo e(url('/front/ ')); ?>" class="nav-item nav-link">Home</a>
                    <a href="<?php echo e(url('/front/destinations')); ?>" class="nav-item nav-link active">Destination</a>
...
</html><?php /**PATH C:\Users\MSI\Desktop\5eme\Laravel\projet\Laravel_RescuFood\resources\views/template/destinations_list.blade.php ENDPATH**/ ?>