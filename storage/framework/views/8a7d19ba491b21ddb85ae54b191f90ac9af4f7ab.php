...
<?php $component->withAttributes([]); ?>
    <div class="accommodation-content">
        ...
        <form action="<?php echo e(route('accommodations.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-3">
                ...
                <a href="<?php echo e(route('accommodations.index')); ?>" class="btn btn-secondary">Annuler</a>
            </div>
        </form>
    </div>
...
<?php endif; ?>
<?php /**PATH D:\Xampp\htdocs\Laravel_tourismeDurable\resources\views/accommodations/create.blade.php ENDPATH**/ ?>