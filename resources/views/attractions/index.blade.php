        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $attraction->id }}</td>
                    <td>
                        <a href="{{ route('attractions.show', $attraction) }}">{{ $attraction->name }}</a>
                    </td>
                    <td>{{ $attraction->description }}</td>
                    <td>
                        @if($attraction->destination && $attraction->destination->image)
                        <img src="{{ asset('storage/' . $attraction->destination->image) }}" alt="{{ $attraction->destination->name }}" style="width: 100px; height: auto;">
                        @else
                        No Image
                        @endif
                    </td>
                    ...
                    <td>{{ $attraction->destination->name ?? 'No Destination' }}</td> <!-- Displaying destination name -->

                    <td>
                    <div class="d-flex align-items-center">
                        <!-- Button to edit the attraction -->
                        <a href="{{ route('attractions.edit', $attraction) }}" class="editBtn">
                        ...
                        <form action="{{ route('attractions.destroy', $attraction) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
