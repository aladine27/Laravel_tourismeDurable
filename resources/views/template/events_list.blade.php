                    ...
                    <div class="package-item">
                        ...
                        <div class="d-flex border-bottom">
                            <small class="flex-fill text-center border-end py-2">
                                <i class="fa fa-map-marker-alt text-primary me-2"></i>{{ $event->getAddress() }}
                            </small>
                            <small class="flex-fill text-center border-end py-2">
                                <i class="fa fa-calendar-alt text-primary me-2"></i>{{ \Carbon\Carbon::parse($event->date)->diffForHumans() }}
                            </small>
                            <small class="flex-fill text-center py-2">
                                <i class="fa fa-user text-primary me-2"></i>{{ $event->tickets->count() }} Person
                            </small>
                        </div>
                        <div class="text-center p-4">
                        @foreach($event->tickets as $ticket)
                            <h3 class="mb-0"> {{ $ticket->type }} ${{ number_format($ticket->price, 2) }}</h3>
                            @endforeach
