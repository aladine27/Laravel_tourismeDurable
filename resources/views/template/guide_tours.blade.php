    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach ($guide->tours as $tour)
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <div class="p-6">
                    <h4 class="text-xl font-semibold text-gray-800">{{ $tour->title }}</h4>
                    <p class="text-gray-600 mt-2">{{ $tour->description }}</p>
                    <p class="text-gray-500 mt-2"><strong>Date:</strong> {{ \Carbon\Carbon::parse($tour->date)->format('d-m-Y') }}</p>
                    <p class="text-gray-500 mt-2"><strong>Duration:</strong> {{ $tour->duration }} days</p>
                    <p class="text-gray-500 mt-2"><strong>Price:</strong> ${{ number_format($tour->price, 2) }}</p>
                    <p class="text-gray-500 mt-2"><strong>Available Spots:</strong> {{ $tour->nb_place }}</p>
                    <a href="#" class="inline-block mt-4 px-4 py-2 bg-blue-500 text-white text-center rounded-lg hover:bg-blue-700 transition">Book Now</a>
                </div>
            </div>
        @endforeach
    </div>
